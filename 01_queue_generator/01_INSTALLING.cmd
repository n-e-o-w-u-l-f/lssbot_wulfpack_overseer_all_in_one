...
echo.
echo ================================================================
echo LSS Character Queue v5.0 FINAL - Installing
echo ================================================================
echo Saved language: %LSS_QUEUE_LANG%
echo Saved emulator: %LSS_QUEUE_EMULATOR%
echo.
...
echo.
py -3 "%~dp0lss_character_queue_v5_final.py" --lang %LSS_QUEUE_LANG% --emulator-type %LSS_QUEUE_EMULATOR% %*
